...
import com.easyder.club.testing.TestingFragment;
...
public class LoginActivity extends WrapperMvpActivity<CommonPresenter> {

    boolean retry;  //是否为再次登录
    boolean enable = false; //是否开启选择站点功能
    ...
    protected void setImmersionBar() {
        ImmersionBar.with(mActivity).barColor("#303642").init();
    }
