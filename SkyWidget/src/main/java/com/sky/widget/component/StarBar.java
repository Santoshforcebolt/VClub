...
public class StarBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.starDistance = AutoUtils.getPercentWidthSize((int) mTypedArray.getDimension(R.styleable.StarBar_starDistance, 0));
        this.starSize = AutoUtils.getPercentWidthSize((int) mTypedArray.getDimension(R.styleable.StarBar_starSize, 20));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (changeable) {
            ...
            if (x < 0) x = 0;
            if (x > getAutoMeasuredWidth()) x = getAutoMeasuredWidth();
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN: {
                    setStarMark(x * 1.0f / (getAutoMeasuredWidth() * 1.0f / starCount));
                    break;
                }
    ...
    private int getAutoMeasuredWidth() {
