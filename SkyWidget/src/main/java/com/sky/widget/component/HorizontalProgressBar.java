...
public class HorizontalProgressBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        max = a.getInteger(R.styleable.HorizontalProgressBar_hpb_max, 100);
        progress = a.getInteger(R.styleable.HorizontalProgressBar_hpb_progress, 0);
        bgColor = a.getColor(R.styleable.HorizontalProgressBar_hpb_bg_color, 0xff3F51B5);
        progressColor = a.getColor(R.styleable.HorizontalProgressBar_hpb_pb_color, 0xffFF4081);
        secondProgressColor = a.getColor(R.styleable.HorizontalProgressBar_hpb_second_pb_color, 0xffFF4081);
        padding = a.getDimensionPixelSize(R.styleable.HorizontalProgressBar_hpb_padding, 2);
        showSecondProgress = a.getBoolean(R.styleable.HorizontalProgressBar_hpb_show_second_progress, false);
        secondProgress = a.getInteger(R.styleable.HorizontalProgressBar_hpb_second_progress, 0);
        secondProgressShape = a.getInteger(R.styleable.HorizontalProgressBar_hpb_show_second_point_shape, 0);
        openGradient = a.getBoolean(R.styleable.HorizontalProgressBar_hpb_open_gradient, false);
        gradientFrom = a.getColor(R.styleable.HorizontalProgressBar_hpb_gradient_from, 0xffFF4081);
        gradientTo = a.getColor(R.styleable.HorizontalProgressBar_hpb_gradient_to, 0xffFF4081);
        openSecondGradient = a.getBoolean(R.styleable.HorizontalProgressBar_hpb_open_second_gradient, false);
        secondGradientFrom = a.getColor(R.styleable.HorizontalProgressBar_hpb_second_gradient_from, 0xffFF4081);
        secondGradientTo = a.getColor(R.styleable.HorizontalProgressBar_hpb_second_gradient_to, 0xffFF4081);
        a.recycle();
    }
