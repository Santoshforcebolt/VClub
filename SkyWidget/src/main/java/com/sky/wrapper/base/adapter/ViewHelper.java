...
public class ViewHelper {
     ...
     * @param url
     */
    public void setImageManager(Context context, int viewId, String url) {
        ImageManager.load(context, (ImageView) getView(viewId), url, -1);
    }
     ...
     * @param placeholder
     */
    public void setImageManager(Context context, int viewId, String url, int placeholder) {
        ImageManager.load(context, (ImageView) getView(viewId), url, placeholder, -1);
    }


    public void setImageManager(Context context, ImageView imageView, String url, int placeholder) {
        ImageManager.load(context, imageView, url, placeholder, -1);
    }
     ...
     */
    public void setImageManager(Context context, int viewId, String url, int placeholder, int error) {
        ImageManager.load(context, (ImageView) getView(viewId), url, placeholder, error);
    }

    public void setImageManager(Context context, int viewId, String url, BitmapTransformation transformation, int placeholder) {
        ImageManager.load(context, (ImageView) getView(viewId), url, transformation, placeholder, -1);
    }
     ...
     * @param text
     */
    public ViewHelper setTextLine(int viewId, CharSequence text) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public ViewHelper setViewScroll(int viewId) {
        View view = getView(viewId);
        if (view instanceof TextView) {
            TextView textView = (TextView) view;
            textView.setMovementMethod(ScrollingMovementMethod.getInstance());//内容文字可滑动
        }
        return this;
    }
