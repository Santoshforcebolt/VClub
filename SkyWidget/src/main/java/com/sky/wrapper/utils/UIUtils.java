...
public class UIUtils {
    ...
    public static Context getContext() {
        return ManagerConfig.getInstance().getApplicationContext();
    }
    ...
    public static Handler getHandler() {
        return ManagerConfig.getInstance().getMainThreadHandler();
...
//        return MainApplication.getMainThreadId();
        return ManagerConfig.getInstance().getMainThreadId();
    }
